...
GAME_RUNNING_CHECK_COLOR_BLACK = 0x191919
...
if A_ExitReason in Logoff,Shutdown,Close,Menu,Exit ; 在这行语句中, 注意不要在逗号周围含有空格
{
	if (OPERATE_MODE = 1)
	{
		...
		else if !CheckPixel(GAME_RUNNING_CHECK_X, GAME_RUNNING_CHECK_Y, GAME_RUNNING_CHECK_COLOR_NORMAL, GAME_RUNNING_CHECK_COLOR_DARK, GAME_RUNNING_CHECK_COLOR_BLACK)
			return
		GoHome()
		if !CheckPixel(CAREER_RACE_X, CAREER_RACE_Y, CAREER_RACE_COLOR)
			RandomClick(CAREER_RACE_X, CAREER_RACE_Y, , DELY_MIDDLE)
