...
; 自动/手动判断相关
OPERATION_MODE_X = 2003
OPERATION_MODE_Y = 840
OPERATION_MODE_RANGE = 12
...
{
	global OPERATION_MODE_X, OPERATION_MODE_Y, OPERATION_MODE_RANGE
	operationModeX := OPERATION_MODE_X
	operationModeY := OPERATION_MODE_Y
	Loop %OPERATION_MODE_RANGE% ; 判断操作模式是否为手动
	{
		operationModeColor := GetPixel(operationModeX, operationModeY)
		if ((operationModeColor & 0xFF00) > 0x7FFF) ; 即：绿色 > 127
			return true
	}
	return false
}
