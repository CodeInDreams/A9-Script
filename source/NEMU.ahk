...
RunApp() ; 启动A9
{
	global EMU_AHK_CLASS, APP_INDEX, EMU_HOME_X, EMU_HOME_Y, APP_OPEN_X, APP_OPEN_Y, DELAY_SHORT, DELAY_SUPER_LONG
	WinActivate ahk_class %EMU_AHK_CLASS%
	if APP_INDEX > 1
		Click %EMU_HOME_X%, %EMU_HOME_Y%
	RandomClick(APP_OPEN_X, APP_OPEN_Y, DELAY_SHORT, DELAY_SUPER_LONG)
}
